...
import calendar_inline.messages as messages
...
def create_calendar(year=None,month=None, current_date=None):
    """
    ...
    if current_date is None: current_date = datetime.datetime.today()
    
    for week in my_calendar:
        row=[]
        for day in week:
            if(day==0 or datetime.date(year, month, day) < current_date.date()):
